...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/snort/snort-2.9.1.ebuild,v 1.5 2012/03/11 14:23:21 kumba Exp $
...
src_install() {
	...
	newinitd "${FILESDIR}/snort.rc12" snort || die "Failed to install snort init script"
